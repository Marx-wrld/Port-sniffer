...
//Implementing the trait to handle the WebSocket connections
//This code handles the messages from the user and sends them back to participants in the room
#[derive(Debug)]
